...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.05, alpha=0.5):
    ...
    def get_maxQ(self, state):
        ...
        print "state with Q values:"
        print state
        print "Q value:"
        print self.Q[state]
        max_val = max(self.Q[state].values())
        maxQ = [k for k, v in self.Q[state].items() if v == max_val]
        print "max Q:"
        print maxQ
    ...
    def createQ(self, state):
        ...
        # create a hashable representation of the state to use as a key
        #stateKey = str(state)
    ...
    def choose_action(self, state):
        ...
        if self.learning is True:
            ...
            if p_random <= 1-self.epsilon: #(1-epsilon probability choose random)
                # check wether thera are multiple max values
                if len(maxQ) > 0:
    ...
    def update(self):
        ...
        next_state = self.build_state()     # get state after action taken
